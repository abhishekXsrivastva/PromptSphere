    ...
    lg:px-8 py-12'>
      ...
      <div className='flex flex-wrap justify-center gap-8'>
        {plans.map((plan)=>(
          ...
          rounded-lg shadow hover:shadow-lg transition-shadow p-6 min-w-[300px] flex flex-col ${plan._id === "pro" ?
            "bg-purple-50 dark:bg-purple-900" : "bg-white dark:bg-transparent" }`}>
              ...
              <button onClick={() => toast.promise(purchasePlan(plan._id), {loading: 'Processing payment...'})}className='mt-6 bg-purple-600 hover:bg-purple-700
